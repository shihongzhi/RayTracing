...
public:
  ...
  static void MultRow(Vec3f &c, const Vec3f &v1, const Vec3f &v2){
	float x = v1.data[0] * v2.data[0];
	float y = v1.data[1] * v2.data[1];
	float z = v1.data[2] * v2.data[2];
	c.data[0] = x; c.data[1] = y; c.data[2] = z;}
  static void GetThreeMax(Vec3f &c, const Vec3f &v1, const Vec3f &v2, const Vec3f &v3){
	  float x = Utility::getMax(v1.data[0],v2.data[0],v3.data[0]);
	  float y = Utility::getMax(v1.data[1],v2.data[1],v3.data[1]);
	  float z = Utility::getMax(v1.data[2],v2.data[2],v3.data[2]);
	  c.data[0] = x; c.data[1] = y; c.data[2] = z;}
  static void GetThreeMin(Vec3f &c, const Vec3f &v1, const Vec3f &v2, const Vec3f &v3){
	  float x = Utility::getMin(v1.data[0],v2.data[0],v3.data[0]);
	  float y = Utility::getMin(v1.data[1],v2.data[1],v3.data[1]);
	  float z = Utility::getMin(v1.data[2],v2.data[2],v3.data[2]);
	  c.data[0] = x; c.data[1] = y; c.data[2] = z;}
